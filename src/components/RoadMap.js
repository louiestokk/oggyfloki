...
const RoadMap = () => {
  const boxes = [
    ...
    { number: '3', points: ['Launching public sale and mobile app.', 'Integrating with charities and developing a charity platform.', 'Punkt I','Expanding token holder rewards.','Pursuing partnerships with wallets and exchanges.','Listing on centralized exchanges.','Organizing community events and exploring further development of the ecosystem.'] },
  ];
